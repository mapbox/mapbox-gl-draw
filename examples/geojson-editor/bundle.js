  ...
  _createClass(App, [{
    ...
    value: function fetchURL(e) {
      ...
      fetch(e.target.value).then(function (res) {
        ...
        Draw.clear().set(data);
        var ext = (0, _turfExtent2['default'])(data);
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement('span', { className: 'col1 icon sprocket' }),
          _react2['default'].createElement(
            'h3',
            { className: 'col10' },
            'Control Panel'
          ),
          _react2['default'].createElement('span', { className: 'col1 icon caret-' + (this.state.settings ? 'down' : 'left') })
        ),
        this.state.settings && _react2['default'].createElement(
          ...
          this.state.mode === MAPBOX && _react2['default'].createElement(
            'div',
            null,
            _react2['default'].createElement(
              'fieldset',
              { className: 'with-icon dark' },
              _react2['default'].createElement('span', { className: 'icon mapbox' }),
          ...
          this.state.mode === NORM && _react2['default'].createElement(
            'div',
            null,
            _react2['default'].createElement(
              'fieldset',
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement('span', { className: 'col1 icon pencil' }),
          _react2['default'].createElement(
            'h3',
            { className: 'col10' },
            'Editor'
          ),
          _react2['default'].createElement('span', { className: 'col1 icon caret-' + (this.state.geojsonEditPane ? 'down' : 'left') })
        ),
        this.state.geojsonEditPane && _react2['default'].createElement(
          'div',
          { className: 'clearfix' },
          _react2['default'].createElement(
            'div',
...
_reactDom2['default'].render(_react2['default'].createElement(App, null), document.getElementById('geojson'));

},{"./client":1,"geojson-validation":3,"react":160,"react-dom":4,"turf-extent":161}],3:[function(require,module,exports){
/**
...
},{"turf-meta":162}],162:[function(require,module,exports){
/**
